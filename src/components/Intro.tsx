  ...
  return (
    <section id="intro" className="text-center w-11/12 mx-auto">
      ...
      <p className="max-w-xl mx-auto mt-3 font-bold ">
        ...
        this it means that I am currently looking for a job. I'm a careful and
        hard working person, I am eager to learn new things and willing to work
        in team. Feel free to get in touch with me.
      </p>
    </section>
  );
};
